...
const Formdata = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefire.online/HTF");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HTF ?? "horsefire.online/htf");
    ...
    return (<div className="bg-gray-200 rounded-md p-2" id="form">
        ...
        <div className={`pb-4 text-black ${poppin.className}`} id='formcallhide'>
            <div className="max-w-2xl md:mx-auto  bg-slate-50 p-3 border border-black rounded-xl">
                <div className="py-4">
