...
const page = () => {
    return (
        <section className='w-full md:max-w-5xl mx-auto bg-gray-100 text-black'>
            <div className=''>
                <div className='fontNoto text-2xl pt-6 font-extrabold px-2 text-center'>
                    गोपनीयता नीति
                </div>
                ...
                <div className='fontNoto text-2xl pt-6 font-extrabold px-2'>
                    1. उद्देश्य:-
                </div>
                ...
                <ul className='fontNoto ml-5  list-disc px-2 py-2 text-[1rem] sm:text-[1.1rem] text-justify'>
                    ...
                    <li>
                        horsefire tablet की कीमत  रु. 2300  में सभी लागू कर और शुल्क शामिल हैं। आपसे ऑफर मूल्य से अधिक कोई अतिरिक्त राशि नहीं ली जाएगी।
                    </li>
                    <li>
