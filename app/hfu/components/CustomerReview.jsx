...
const CustomerReview = () => {
    ...
    const itemsToShow = useMemo(() => {
        return Reviews
            .slice(0, numberOfitemsShown).map((e, key) => {
                ...
                return <div key={key}>
                    <div className={`text-black my-5 p-2 rounded-md ${e.customer_name === "Nitya" ? "ml-[10%]" : ""}`} style={{ boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }} key={key}>
    ...
    return (
        <section className='reason_bg md:py-7'>
            <div className=' sm:max-w-3xl mx-auto w-full bg-white rounded-xl  overflow-hidden'>
                <div className="px-2 pt-4 w-full">
                    <div className='fontPoppins text-black text-2xl font-bold mb-4 text-center'>What Our <span className="text-red-600">Customer's Say</span></div>
