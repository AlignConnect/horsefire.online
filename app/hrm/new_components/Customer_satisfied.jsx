    ...
    return (
        <section>
            ...
            <div className="reason_bg">
                <div className="sm:max-w-[70%] mx-auto pt-5 sm:py-7">
                    ...
                    <div className="grid sm:grid-cols-2 items-center ">
                        ...
                        <div className="">
                            ...
                            <div className="fontBebas uppercase sm:text-[4vw] text-[3rem] font-extrabold  sm:text-left text-center pt-5 text-black">
                            ...
                            <div className="grid sm:grid-cols-3 grid-cols-2 items-center sm:justify-normal justify-center py-2 sm:border-none border border-solid border-gray-400 rounded-lg mx-3">
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/1369a0a5-d191-4392-bf47-5c170ecb8600/public" alt="" className="w-5/6 sm:w-3/5     mx-auto" />
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/3edacd08-1afb-49b1-9aba-2cdda7681400/public" alt="" className="w-5/6 sm:w-3/5 mx-auto" />

                            </div>

                            <p className="fontPoppins py-3">
