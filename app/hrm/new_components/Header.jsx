                    ...
                    <div className="grid sm:grid-cols-2 items-center sm:py-16 py-5">
                        ...
                        <div className=" leading-tight">
                            ...
                            <div className="text-left sm:block hidden">
                                <a href="#form"><div className="cursor-pointer fontPoppins px-8 py-1 bg-black inline-block  text-white text-[1.2vw] font-semibold rounded hover:bg-gray-600 my-3 ">
                                    ORDER NOW
                                </div>
                                </a>
                            </div>
