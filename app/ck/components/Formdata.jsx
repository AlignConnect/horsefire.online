...
const Formdata = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefire.online/CK");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_CK ?? "horsefire.online/ck");
    ...
    return (<div className="bg-inherit rounded-md p-2" id="form">
        ...
        <h1 className="text-2xl sm:text-2xl text-center  text-black font-extrabold px-2 py-5 md:pt-5">
