...
const Story = () => {
        ...
        return arr.map((e, key) => {
            ...
            return <div className='' key={key}>
                ...
                <div className='bg-[#FEFAF6]'>
                    ...
                    <div className='grid sm:grid-cols-2 items-center m-2 ' >
                        <div className="">

                            <img src={e.img} alt="herbs" className='w-full h_t rounded-tl-2xl rounded-br-2xl sm:w-full' />

                        </div>

                        <div className='text-2xl sm:text-3xl text-center text-red-700 font-extrabold pt-2'>{e.title}</div>
                    </div>
    ...
    return (
        <section>
            ...
            <p className='px-2 py-2 text-justify'>
                दोस्तों, <span className='text-red-700'>Horse Fire Tablet.</span> के इस्तेमाल से खेल से पहले स्फूर्ति, आत्मविश्वास और टाइमिंग में सुधार होता है जिससे वो अपने पार्टनर को संतुष्ट कर सके। इसकी वजह से पूरे भारत में इसका इस्तेमाल तेजी से बढ़ा है। इसके इस्तेमाल से विस्फोटक पारी खेल रहे है और एक रोमांचक जीवन व्यतीत कर रहे है।
            </p>

            <div className="fontNoto text-center text-3xl sm:text-4xl pt-4 sm:pt-4 font-extrabold px-2  mx-4" style={{ boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }}>
                हॉर्सफायर मदद करता है
            </div>

            <img src="/main/htb_images/p8.webp" alt="" className='md:w-3/4 w-full px-4 mx-auto py-10 ' />
