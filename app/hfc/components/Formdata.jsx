...
const Formdata = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefire.online/HFC");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFC ?? "horsefire.online/hfc");
    ...
    return (<div className={`${noto.className} rounded-md p-2" id="form`} id='form'>
        ...
        {/* <h1 className="text-2xl text-center  text-black font-extrabold px-2 py-5 md:pt-5">
            <div className="max-w-xl mx-auto">
                कॉल पर विशेषज्ञ डॉक्टरों से मुफ्त सलाह के लिए फॉर्म भरें !
            </div>
        </h1> */}

        <div className={`pb-4 px-3 text-black ${poppin.className}`} id='formcallhide'>
            <div className="max-w-2xl md:mx-auto p-3 border border-black rounded-xl  md:w-[500px]" id='formContainer'>
                <div className="py-4">
                    <div className="text-center">
                        <h1 className="text-2xl text-white font-bold border-b mb-5 inline-block border-black"> Contact Us </h1>
                    </div>
                    <form className="space-y-2 ">

                        {CustomerDataValue?.map((data, key) => {
                            return <div className="flex flex-col" key={key}>
                                <label className={`${noto.className} text-xl font-semibold text-white  py-1`}>{data.label}</label>
                        ...
                        <div className="flex justify-center items-center pt-4 ">
                            <button onClick={handleFormSubmit} type="button" className="bg-red-900 text-xl font-bold p-3 pt-3 md:w-72 w-full rounded-md hover:bg-zinc-950 transition-colors text-white" style={{ boxShadow: "1px 1px 9px 1px black" }}>
                                SUBMIT
                            </button>
                        </div>
                    </form>
